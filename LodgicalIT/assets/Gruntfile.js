	...
	uglify: {
		dist: {
			files: {
				...
				'../markup/js/clients-and-partners.min.js': ['dist/js/clients-and-partners.js']
			}
		}
	},
            ...
            options: {
                ...
                sections: {
                    ...
                    layout: {
                    	...
                    	form_section: '<%= fixturesPath %>/templates/form-section.html',
                    	map_section: '<%= fixturesPath %>/templates/map-section.html'
					}
                },
            }
        }
